  ...
  const iniciarEfectoEscritura = () => {
    ...
    const intervalo = setInterval(() => {
      if (i < nombreCompleto.length) {
        ...
        // Mantenemos el cursor parpadeando al final
      }
    }, 150)
  }
  ...
  <div class="min-h-screen bg-slate-50 text-slate-800 overflow-x-hidden font-body">
    ...
    <header class="relative h-screen w-full flex flex-col justify-center items-center text-center overflow-hidden px-4">
      ...
      <div class="absolute inset-0 z-0 bg-stone-100">
        ...
        <img :src="datos.fotoPortada" class="w-full h-full object-cover opacity-90" alt="Fondo" />
      </div>
      ...
      <div class="mariposas-container absolute inset-0 z-20 pointer-events-none overflow-hidden">
        <img v-for="n in 10" :key="n" src="/assets/mariposa-lila.png" class="mariposa absolute opacity-60" />
      </div>
    
      <transition name="fade">
        <div v-if="esPremium" class="absolute top-6 z-40 animate-pulse delay-700">
           <div class="bg-white/80 backdrop-blur-md border border-purple-200 px-6 py-2 rounded-full shadow-lg">
             <p class="text-purple-900 text-xs font-bold tracking-wide uppercase">✨ Invitada Especial ✨</p>
           </div>
        </div>
      </transition>
    
      <div class="relative z-30 text-purple-900 flex flex-col gap-12 justify-center items-center h-full w-full max-w-6xl mx-auto space-y-1 md:space-y-6">
        
        <div class="text-[#75527e]/80 opacity-90 animacion-tiara -mb-6 md:mb-0 relative z-10">
          <svg id="OBJECTS" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 418.172 135.699" class="w-28 md:w-32 h-auto mx-auto fill-current">
        ...
        <div class="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 w-full animate-fade-in-up">
          
          <div class="relative shrink-0 group transform scale-90 md:scale-100 z-20">
            <div class="absolute -inset-2 bg-purple-200/50 rounded-full blur opacity-70 group-hover:opacity-100 transition duration-700"></div>
            <div class="absolute z-20 w-[125%] h-[125%] -top-[12.5%] -left-[12.5%] -translate-x-[20px] pointer-events-none rotate-12 group-hover:rotate-0 transition-transform duration-1000">
              <img src="/assets/marco-flores-lila-circular.png" class="w-full h-full object-contain" />
            </div>
            <div class="relative w-40 h-40 md:w-48 md:h-48 rounded-full border-4 border-white overflow-hidden z-10 shadow-xl">
              <img :src="datos.fotoPortada" class="w-full h-full object-cover object-top" />
            </div>
          </div>
      
          <div class="text-center md:text-left -mt-4 md:mt-0 relative z-30">
            <div class="flex items-end justify-center md:justify-start gap-2 text-[#75527e]/90 leading-none">
               <span class="font-luxurious text-4xl md:text-4xl drop-shadow-sm mb-2">mis</span>
               <span class="font-seasons font-normal text-[7rem] md:text-9xl text-[#75527e] drop-shadow-md leading-[0.8]">15</span>
               <span class="font-luxurious text-4xl md:text-4xl drop-shadow-sm mb-2">años</span>
            </div>
      
            <h1 class="font-luxurious text-[4.5rem] md:text-8xl text-[#75527e] drop-shadow-lg leading-[0.9] -mt-2 md:mt-0 px-2 break-words">
              {{ nombreMostrado }}
      ...
      <div class="absolute bottom-6 z-30 animate-bounce text-[#75527e]/70">
